...
public class SomF2M1 : MonoBehaviour
{
    public GameObject somFaseCompletada, somComendo, somErrou, somAcertou;
    ...
    void Update()
    {
        if(SomMusicaControl.somOnOff==0) {
            ...
            somComendo.GetComponent<AudioSource>().mute=false;
            ...
            somComendo.GetComponent<AudioSource>().mute=true;
